...
impl Game<PTGameConfig> for PTGame {
    ...
    fn client_join(&self, client: &mut Client<PTGameConfig>, world: &mut World<PTGameConfig>) {

    }

    fn client_leave(&self, client: &mut Client<PTGameConfig>, world: &mut World<PTGameConfig>) {
